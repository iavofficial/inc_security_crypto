...
/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_192fSimple_sign.c
* \brief  description of FsmSw_SphincsShake_192fSimple_sign.c
*
* \details
*
*
                                                                  ...
                                                                  const uint8 *const seed)
{
   ...
   * on the public seed. */
  FsmSw_SphincsShake_192fSimple_InitializeHashFunction(&ctx);

  /* Compute root node of the top-most subtree. */
  FsmSw_SphincsShake_192fSimple_Merkle_GenRoot(&sk[3u * FSMSW_SPHINCSSHAKE_192FSIMPLE_N], &ctx);

  /* cleanup */
  FsmSw_SphincsShake_192fSimple_2FreeHashFunction(&ctx);
  ...
  return;
} // end: fsmsw_sphincsshake_192fsimple_crypto_sign_SeedKeyPair
/**********************************************************************************************************************/
...
void FsmSw_SphincsShake_192fSimple_Crypto_Sign_KeyPair(uint8 *const pk, uint8 *const sk)
{
  ...
  fsmsw_sphincsshake_192fsimple_crypto_sign_SeedKeyPair(pk, sk, seed);

  return;
} // end: FsmSw_SphincsShake_192fSimple_Crypto_Sign_KeyPair
                                                         ...
                                                         uint32 mlen, const uint8 *const sk)
{
  ...
  FsmSw_SphincsShake_192fSimple_GenMessageRandom(sig_temp, sk_prf, optrand, m, mlen, &ctx);

  /* Derive the message digest and leaf index from R, PK and M. */
  FsmSw_SphincsShake_192fSimple_HashMessage(mhash, &tree, &idx_leaf, sig_temp, pk, m, mlen, &ctx);
  ...
  for (i = 0; i < FSMSW_SPHINCSSHAKE_192FSIMPLE_D; i++)
  {
    ...
    FsmSw_SphincsShake_192fSimple_Merkle_Sign(sig_temp, root, &ctx, wots_addr, tree_addr, idx_leaf);
    sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_BYTES +
                         (FSMSW_SPHINCSSHAKE_192FSIMPLE_TREE_HEIGHT * FSMSW_SPHINCSSHAKE_192FSIMPLE_N)];
  ...
  *siglen = FSMSW_SPHINCSSHAKE_192FSIMPLE_BYTES;
  ...
  return;
} // end: FsmSw_SphincsShake_192fSimple_Crypto_Sign_Signature
                                                       ...
                                                       uint32 mlen, const uint8 *const pk)
{
  ...
  FsmSw_SphincsShake_192fSimple_Fors_PkFromSig(root, sig_temp, mhash, &ctx, wots_addr);
  sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_BYTES];
  ...
  for (i = 0; i < FSMSW_SPHINCSSHAKE_192FSIMPLE_D; i++)
  {
    ...
    FsmSw_SphincsShake_192fSimple_Wots_PkFromSig(wots_pk, sig_temp, root, &ctx, wots_addr);
    sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_BYTES];
    ...
    FsmSw_SphincsShake_192fSimple_ComputeRoot(root, leaf, idx_leaf, 0, sig_temp,
                                              FSMSW_SPHINCSSHAKE_192FSIMPLE_TREE_HEIGHT, &ctx, tree_addr);
    sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_192FSIMPLE_TREE_HEIGHT * FSMSW_SPHINCSSHAKE_192FSIMPLE_N];
  ...
  return retVal;
} // end: FsmSw_SphincsShake_192fSimple_Crypto_Sign_Verify
                                               ...
                                               const uint8 *const sk)
{
  ...
  *smlen = siglen + mlen;
  ...
  return;
} // end: FsmSw_SphincsShake_192fSimple_Crypto_Sign
