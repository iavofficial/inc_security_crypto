 ...
 ** @{ */
/** \addtogroup SphincsSha2_256sSimple_params
 ** @{ */

/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_256sSimple_params.h
* \brief  Description of FsmSw_SphincsSha2_256sSimple_params.h
*
* \details
*
*
...
#define FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_LEN1                                                                         \
  (8u * FSMSW_SPHINCSSHA2_256SSIMPLE_N / FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_LOGW)
...
#define FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_LEN                                                                          \
  (FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_LEN1 + FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_LEN2)
#define FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_BYTES (FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_LEN * FSMSW_SPHINCSSHA2_256SSIMPLE_N)

/* Subtree size. */
#define FSMSW_SPHINCSSHA2_256SSIMPLE_TREE_HEIGHT                                                                       \
  (FSMSW_SPHINCSSHA2_256SSIMPLE_FULL_HEIGHT / FSMSW_SPHINCSSHA2_256SSIMPLE_D)

/* FORS parameters. */
#define FSMSW_SPHINCSSHA2_256SSIMPLE_FORS_MSG_BYTES                                                                    \
  (((FSMSW_SPHINCSSHA2_256SSIMPLE_FORS_HEIGHT * FSMSW_SPHINCSSHA2_256SSIMPLE_FORS_TREES) + 7u) / 8u)
#define FSMSW_SPHINCSSHA2_256SSIMPLE_FORS_BYTES                                                                        \
  ((FSMSW_SPHINCSSHA2_256SSIMPLE_FORS_HEIGHT + 1u) *                                                                   \
   (FSMSW_SPHINCSSHA2_256SSIMPLE_FORS_TREES * FSMSW_SPHINCSSHA2_256SSIMPLE_N))

/* Resulting SPX sizes. */
#define FSMSW_SPHINCSSHA2_256SSIMPLE_BYTES                                                                             \
  (FSMSW_SPHINCSSHA2_256SSIMPLE_N + FSMSW_SPHINCSSHA2_256SSIMPLE_FORS_BYTES +                                          \
   (FSMSW_SPHINCSSHA2_256SSIMPLE_D * FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_BYTES) +                                        \
   (FSMSW_SPHINCSSHA2_256SSIMPLE_FULL_HEIGHT * FSMSW_SPHINCSSHA2_256SSIMPLE_N))
...
#define FSMSW_SPHINCSSHA2_256SSIMPLE_SK_BYTES                                                                          \
  (2 * FSMSW_SPHINCSSHA2_256SSIMPLE_N + FSMSW_SPHINCSSHA2_256SSIMPLE_PK_BYTES)
