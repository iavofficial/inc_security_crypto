...
/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_256sSimple_thash_sha2_simple.c
* \brief  description of FsmSw_SphincsSha2_256sSimple_thash_sha2_simple.c
*
* \details
*
*
...
/*====================================================================================================================*/
/**
 * \brief Takes an array of inblocks concatenated arrays of FSMSW_SPHINCSSHA2_256SSIMPLE_N bytes.
 *
                                        ...
                                        const sphincs_sha2_256s_ctx *const ctx, const uint32 addr[8])
{
  ...
  FsmSw_Sha256_IncFinalize(outbuf, &sha2_state, buf,
                           SPX_SHA256_ADDR_BYTES + (inblocks * FSMSW_SPHINCSSHA2_256SSIMPLE_N));
  FsmSw_CommonLib_MemCpy(out, outbuf, FSMSW_SPHINCSSHA2_256SSIMPLE_N);
} // end: FsmSw_SphincsSha2_256sSimple_Thash
