...
/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_256fSimple_thash_sha2_simple.c
* \brief  description of FsmSw_SphincsSha2_256fSimple_thash_sha2_simple.c
*
* \details
*
*
...
/*====================================================================================================================*/
/** 
 * \brief Takes an array of inblocks concatenated arrays of FSMSW_SPHINCSSHA2_256FSIMPLE_N bytes.
 *
                                        ...
                                        const sphincs_sha2_256f_ctx *const ctx, const uint32 addr[8])
{
  ...
  uint8 buf[SPX_SHA256_ADDR_BYTES + (FSMSW_SPHINCSSHA2_256FSIMPLE_THASH_BUF_LEN * FSMSW_SPHINCSSHA2_256FSIMPLE_N)] = {
      0};
  ...
  FsmSw_CommonLib_MemCpy(&buf[SPX_SHA256_ADDR_BYTES], in, inblocks * FSMSW_SPHINCSSHA2_256FSIMPLE_N);

  FsmSw_Sha256_IncFinalize(outbuf, &sha2_state, buf,
                           SPX_SHA256_ADDR_BYTES + (inblocks * FSMSW_SPHINCSSHA2_256FSIMPLE_N));
  FsmSw_CommonLib_MemCpy(out, outbuf, FSMSW_SPHINCSSHA2_256FSIMPLE_N);
} // end: FsmSw_SphincsSha2_256fSimple_Thash
