...
#define mgf1_X                FsmSw_SphincsSha2_192sSimple_MgF1512
...
{
  uint8 inbuf[FSMSW_SPHINCSSHA2_192SSIMPLE_MGF1_256_BUF_LEN + 4u] = {0};
...
} // end: FsmSw_SphincsSha2_192sSimple_MgF1256
...
} // end: FsmSw_SphincsSha2_192sSimple_MgF1512
                                                   ...
                                                   const sphincs_sha2_192s_ctx *const ctx)
{
  ...
  FsmSw_CommonLib_MemSet(&buf[FSMSW_SPHINCSSHA2_192SSIMPLE_N], 0x36,
  ...
  FsmSw_CommonLib_MemSet(&buf[FSMSW_SPHINCSSHA2_192SSIMPLE_N], 0x5C,
                         SPX_SHAX_BLOCK_BYTES - FSMSW_SPHINCSSHA2_192SSIMPLE_N);
