...
/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_192fSimple_hash_shake.c
* \brief  description of FsmSw_SphincsShake_192fSimple_hash_shake.c
*
* \details
*
*
...
void FsmSw_SphincsShake_192fSimple_PrfAddr(uint8 *const out, const sphincs_shake_192f_ctx *const ctx,
                                           const uint32 addr[8])
{
  uint8 buf[(2u * FSMSW_SPHINCSSHAKE_192FSIMPLE_N) + FSMSW_SPHINCSSHAKE_192FSIMPLE_ADDR_BYTES] = {0};
  ...
  FsmSw_CommonLib_MemCpy(&buf[FSMSW_SPHINCSSHAKE_192FSIMPLE_N + FSMSW_SPHINCSSHAKE_192FSIMPLE_ADDR_BYTES], ctx->sk_seed,
...
} // end: FsmSw_SphincsShake_192fSimple_PrfAddr
                                                    ...
                                                    const sphincs_shake_192f_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, sk_prf, FSMSW_SPHINCSSHAKE_192FSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, optrand, FSMSW_SPHINCSSHAKE_192FSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  FsmSw_Fips202_Shake256_IncFinalize(&s_inc);
  FsmSw_Fips202_Shake256_IncSqueeze(R, FSMSW_SPHINCSSHAKE_192FSIMPLE_N, &s_inc);
} // end: FsmSw_SphincsShake_192fSimple_GenMessageRandom
                                               ...
                                               uint32 mlen, const sphincs_shake_192f_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncInit(&s_inc);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, R, FSMSW_SPHINCSSHAKE_192FSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, pk, FSMSW_SPHINCSSHAKE_192FSIMPLE_PK_BYTES);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  FsmSw_Fips202_Shake256_IncFinalize(&s_inc);
...
} // end: FsmSw_SphincsShake_192fSimple_HashMessage
