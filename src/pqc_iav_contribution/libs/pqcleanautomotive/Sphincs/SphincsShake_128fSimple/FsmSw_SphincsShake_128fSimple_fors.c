...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_128fsimple_fors_GenSk(uint8 *const sk, const sphincs_shake_128f_ctx *const ctx,
                                                     const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128fsimple_fors_SkToLeaf(uint8 *const leaf, const uint8 *const sk,
                                                        const sphincs_shake_128f_ctx *const ctx,
                                                        const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128fsimple_fors_GenLeafx1(uint8 *const leaf, const sphincs_shake_128f_ctx *const ctx,
                                                         uint32 addr_idx, void *const info);
static void fsmsw_sphincsshake_128fsimple_fors_MessageToIndices(uint32 *const indices, const uint8 *const m);
/**********************************************************************************************************************/
