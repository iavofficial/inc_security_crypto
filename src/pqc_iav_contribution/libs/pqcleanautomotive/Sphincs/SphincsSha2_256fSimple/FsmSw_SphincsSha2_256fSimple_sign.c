...
/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_256fSimple_sign.c
* \brief  description of FsmSw_SphincsSha2_256fSimple_sign.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void fsmsw_sphincssha2_256fsimple_crypto_sign_SeedKeyPair(uint8 *const pk, uint8 *const sk,
                                                                 ...
                                                                 const uint8 *const seed)
{
  ...
  return;
} // end: fsmsw_sphincssha2_256fsimple_crypto_sign_SeedKeyPair
/**********************************************************************************************************************/
 ...
 *
 */
void FsmSw_SphincsSha2_256fSimple_Crypto_Sign_KeyPair(uint8 *const pk, uint8 *const sk)
{
  ...
  fsmsw_sphincssha2_256fsimple_crypto_sign_SeedKeyPair(pk, sk, seed);

  return;
} // end: FsmSw_SphincsSha2_256fSimple_Crypto_Sign_KeyPair
...
designed for use by other systems that aim to integrate the Sphincs." */
void FsmSw_SphincsSha2_256fSimple_Crypto_Sign_Signature(uint8 *const sig, uint32 *const siglen, const uint8 *const m,
                                                        uint32 mlen, const uint8 *const sk)
{
  sphincs_sha2_256f_ctx ctx = {{0}};

  const uint8 *const sk_prf = &sk[FSMSW_SPHINCSSHA2_256FSIMPLE_N];
  const uint8 *const pk     = &sk[2u * FSMSW_SPHINCSSHA2_256FSIMPLE_N];
  ...
  *siglen = FSMSW_SPHINCSSHA2_256FSIMPLE_BYTES;
  ...
  return;
} // end: FsmSw_SphincsSha2_256fSimple_Crypto_Sign_Signature
...
/* polyspace +2 MISRA2012:8.7 [Justified:]"This is an interface function
designed for use by other systems that aim to integrate the Sphincs." */
uint8 FsmSw_SphincsSha2_256fSimple_Crypto_Sign_Verify(const uint8 *const sig, uint32 siglen, const uint8 *const m,
                                                      uint32 mlen, const uint8 *const pk)
{
  sphincs_sha2_256f_ctx ctx                                = {{0}};
  const uint8 *const pub_root                              = &pk[FSMSW_SPHINCSSHA2_256FSIMPLE_N];
  uint8 mhash[FSMSW_SPHINCSSHA2_256FSIMPLE_FORS_MSG_BYTES] = {0};
  ...
  return retVal;
} // end: FsmSw_SphincsSha2_256fSimple_Crypto_Sign_Verify
...
and avoids confusion with other functions. Therefore, this warning is a false positive." */
void FsmSw_SphincsSha2_256fSimple_Crypto_Sign(uint8 *const sm, uint32 *const smlen, const uint8 *const m, uint32 mlen,
                                              const uint8 *const sk)
{
  ...
  *smlen = siglen + mlen;
  ...
  return;
} // end: FsmSw_SphincsSha2_256fSimple_Crypto_Sign
...
/* polyspace +2 MISRA2012:5.1 [Justified:]"The identifiers are distinct. The naming convention ensures clarity
and avoids confusion with other functions. Therefore, this warning is a false positive." */
uint8 FsmSw_SphincsSha2_256fSimple_Crypto_Sign_Open(uint8 *const m, uint32 *const mlen, const uint8 *const sm,
                                                    uint32 smlen, const uint8 *const pk)
{
  ...
  *mlen = smlen - FSMSW_SPHINCSSHA2_256FSIMPLE_BYTES;
  ...
  return retVal;
} // end: FsmSw_SphincsSha2_256fSimple_Crypto_Sign_Open
