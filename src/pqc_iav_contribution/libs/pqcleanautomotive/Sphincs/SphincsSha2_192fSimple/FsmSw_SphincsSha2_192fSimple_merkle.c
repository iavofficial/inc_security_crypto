...
/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_192fSimple_merkle.c
* \brief  description of FsmSw_SphincsSha2_192fSimple_merkle.c
*
* \details
*
*
 ...
 * \param[in]  uint32              wots_addr[8] : t.b.d.
                                              ...
                                              uint32 tree_addr[8], uint32 idx_leaf)
{
  ...
  uint32 steps[FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_LEN] = {0};

  info.wots_sig = sig;
  FsmSw_SphincsSha2_192fSimple_Wots_ChainLengths(steps, root);
  ...
  FsmSw_SphincsSha2_192fSimple_TreeHashX1(root, auth_path, ctx, idx_leaf, 0, FSMSW_SPHINCSSHA2_192FSIMPLE_TREE_HEIGHT,
                                          FsmSw_SphincsSha2_192fSimple_Wots_GenLeafX1, tree_addr, &info);
} // end: FsmSw_SphincsSha2_192fSimple_Merkle_Sign
...
void FsmSw_SphincsSha2_192fSimple_Merkle_GenRoot(uint8 *const root, const sphincs_sha2_192f_ctx *const ctx)
{
  ...
  FsmSw_SphincsSha2_192fSimple_Merkle_Sign(auth_path, root, ctx, wots_addr, top_tree_addr,
                                           ~((uint32)0u) /* ~0 means "don't bother generating an auth path */);
} // end: FsmSw_SphincsSha2_192fSimple_Merkle_GenRoot
