...
/* DEFINES                                                                                                            */
/**********************************************************************************************************************/
#define SPX_TREE_BITS  (FSMSW_SPHINCSSHAKE_256SSIMPLE_TREE_HEIGHT * (FSMSW_SPHINCSSHAKE_256SSIMPLE_D - 1u))
                                            ...
                                            const uint32 addr[8])
{
  ...
  FsmSw_CommonLib_MemCpy(&buf[FSMSW_SPHINCSSHAKE_256SSIMPLE_N + FSMSW_SPHINCSSHAKE_256SSIMPLE_ADDR_BYTES], ctx->sk_seed,
                                                      ...
                                                      const sphincs_shake_256s_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, sk_prf, FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, optrand, FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
                                                ...
                                                uint32 mlen, const sphincs_shake_256s_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncInit(&s_inc);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, R, FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, pk, FSMSW_SPHINCSSHAKE_256SSIMPLE_PK_BYTES);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  FsmSw_Fips202_Shake256_IncFinalize(&s_inc);
  FsmSw_Fips202_Shake256_IncSqueeze(buf, SPX_DGST_BYTES, &s_inc);

  FsmSw_CommonLib_MemCpy(digest, bufp, FSMSW_SPHINCSSHAKE_256SSIMPLE_FORS_MSG_BYTES);
  bufp = &bufp[FSMSW_SPHINCSSHAKE_256SSIMPLE_FORS_MSG_BYTES];
