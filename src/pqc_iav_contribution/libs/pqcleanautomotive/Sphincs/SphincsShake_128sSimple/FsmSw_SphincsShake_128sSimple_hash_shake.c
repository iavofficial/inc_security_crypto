 ...
 ** @{ */
/** \addtogroup SphincsShake_128sSimple_hash
 ** @{ */

/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_128sSimple_hash_shake.c
* \brief  description of FsmSw_SphincsShake_128sSimple_hash_shake.c
*
* \details
*
*
 ...
 *
 */
void FsmSw_SphincsShake_128sSimple_PrfAddr(uint8 *const out, const sphincs_shake_128s_ctx *const ctx,
                                           const uint32 addr[8])
{
...
} // end: FsmSw_SphincsShake_128sSimple_PrfAddr

/*====================================================================================================================*/
/**
 * \brief Computes the message-dependent randomness R, using a secret seed and an optional randomization value as
 *        well as the message.
 *
 ...
 *
 */
void FsmSw_SphincsShake_128sSimple_GenMessageRandom(uint8 *const R, const uint8 *const sk_prf,
...
} // end: FsmSw_SphincsShake_128sSimple_GenMessageRandom
 ...
 *
 */
void FsmSw_SphincsShake_128sSimple_HashMessage(uint8 *const digest, uint64 *const tree, uint32 *const leaf_idx,
                                               const uint8 *const R, const uint8 *const pk, const uint8 *const m,
                                               uint32 mlen, const sphincs_shake_128s_ctx *const ctx)
{
  (void)ctx;
...
} // end: FsmSw_SphincsShake_128sSimple_HashMessage
