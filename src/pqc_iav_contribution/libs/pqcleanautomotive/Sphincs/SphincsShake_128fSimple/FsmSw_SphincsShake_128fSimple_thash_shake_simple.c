 ...
 ** @{ */
/** \addtogroup SphincsShake_128fSimple_thash
 ** @{ */

/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_128fSimple_thash_shake_simple.c
* \brief  description of FsmSw_SphincsShake_128fSimple_thash_shake_simple.c
*
* \details
*
*
...
/*====================================================================================================================*/
/**
 * \brief Takes an array of inblocks concatenated arrays of FSMSW_SPHINCSSHAKE_128FSIMPLE_N bytes.
 *
                                         ...
                                         const sphincs_shake_128f_ctx *const ctx, const uint32 addr[8])
{
  ...
  FsmSw_Fips202_Shake256(out, FSMSW_SPHINCSSHAKE_128FSIMPLE_N, buf,
                         FSMSW_SPHINCSSHAKE_128FSIMPLE_N + FSMSW_SPHINCSSHAKE_128FSIMPLE_ADDR_BYTES +
                             (inblocks * FSMSW_SPHINCSSHAKE_128FSIMPLE_N));
} // end: FsmSw_SphincsShake_128fSimple_Thash
