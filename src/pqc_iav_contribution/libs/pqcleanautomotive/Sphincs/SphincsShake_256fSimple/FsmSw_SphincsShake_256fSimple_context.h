...
/**********************************************************************************************************************/
void FsmSw_SphincsShake_256fSimple_InitializeHashFunction(sphincs_shake_256f_ctx *const ctx);

void FsmSw_SphincsShake_256fSimple_1FreeHashFunction(sphincs_shake_256f_ctx *const ctx);
