 ...
 */
static void hqc128_base_mul(uint64 *const c, uint64 a, uint64 b)
{
  uint64 h = 0;
  uint64 l = 0;
  uint64 g;
...
/*====================================================================================================================*/
static void hqc128_karatsuba_add1(uint64 *const alh, uint64 *const blh, const uint64 *const a, const uint64 *const b,
...
/*====================================================================================================================*/
static void hqc128_karatsuba_add2(uint64 *const o, uint64 *const tmp1, const uint64 *const tmp2, uint16 size_l,
                                  uint16 size_h)
{
...
/*====================================================================================================================*/
/**
 * hqc128_karatsuba multiplication of a and b, Implementation inspired from the NTL library.
 *
 ...
 */
static void hqc128_karatsuba(uint64 *const o, const uint64 *const a, const uint64 *const b, uint16 size, uint64 *stack)
{
  ...
  else
  {
    ...
    hqc128_karatsuba(o, a, b, size_l, stack_tmp);
    /* polyspace +2 MISRA2012:17.2 [Justified:]"Without in-depth knowledge, this violation cannot be resolved." */
    /* polyspace +1 CERT-C:MEM05-C [Justified:]"Without in-depth knowledge, this violation cannot be resolved." */
    hqc128_karatsuba(tmp2, ah, bh, size_h, stack_tmp);

    hqc128_karatsuba_add1(alh, blh, a, b, size_l, size_h);
    /* polyspace +2 MISRA2012:17.2 [Justified:]"Without in-depth knowledge, this violation cannot be resolved." */
    /* polyspace +1 CERT-C:MEM05-C [Justified:]"Without in-depth knowledge, this violation cannot be resolved." */
    hqc128_karatsuba(tmp1, alh, blh, size_l, stack_tmp);

    hqc128_karatsuba_add2(o, tmp1, tmp2, size_l, size_h);
  }
} // end: karatsuba
 ...
 */
static void hqc128_gf2x_gf_reduce(uint64 *const o, const uint64 *const a)
{
  uint64 r;
  uint64 carry;
