 ...
 ** @{ */
/** \addtogroup SphincsSha2_192sSimple_params
 ** @{ */

/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_192sSimple_params.h
* \brief  Description of FsmSw_SphincsSha2_192sSimple_params.h
*
* \details
*
*
...
#define FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN1                                                                         \
  (8u * FSMSW_SPHINCSSHA2_192SSIMPLE_N / FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LOGW)
...
#define FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN                                                                          \
  (FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN1 + FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN2)
#define FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_BYTES (FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN * FSMSW_SPHINCSSHA2_192SSIMPLE_N)

/* Subtree size. */
#define FSMSW_SPHINCSSHA2_192SSIMPLE_TREE_HEIGHT                                                                       \
  (FSMSW_SPHINCSSHA2_192SSIMPLE_FULL_HEIGHT / FSMSW_SPHINCSSHA2_192SSIMPLE_D)

/* FORS parameters. */
#define FSMSW_SPHINCSSHA2_192SSIMPLE_FORS_MSG_BYTES                                                                    \
  (((FSMSW_SPHINCSSHA2_192SSIMPLE_FORS_HEIGHT * FSMSW_SPHINCSSHA2_192SSIMPLE_FORS_TREES) + 7u) / 8u)
#define FSMSW_SPHINCSSHA2_192SSIMPLE_FORS_BYTES                                                                        \
  ((FSMSW_SPHINCSSHA2_192SSIMPLE_FORS_HEIGHT + 1u) * FSMSW_SPHINCSSHA2_192SSIMPLE_FORS_TREES *                         \
