...
/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_192sSimple_wots.c
* \brief  description of FsmSw_SphincsSha2_192sSimple_wots.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void fsmsw_sphincssha2_192ssimple_wots_GenChain(uint8 *const out, const uint8 *const in, uint32 start,
                                                       uint32 steps, const sphincs_sha2_192s_ctx *const ctx,
                                                       uint32 addr[8]);
static void fsmsw_sphincssha2_192ssimple_wots_BaseW(uint32 *const output, sint32 out_len, const uint8 *const input);
static void fsmsw_sphincssha2_192ssimple_wots_Checksum(uint32 *const csum_base_w, const uint32 *const msg_base_w);
...
} // end: fsmsw_sphincssha2_192ssimple_wots_GenChain
...
} // end: fsmsw_sphincssha2_192ssimple_wots_BaseW
...
{
  uint32 csum                                                                                                     = 0;
  uint8 csum_bytes[((FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN2 * FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LOGW) + 7u) / 8u] = {0};
  uint32 i                                                                                                        = 0;
  ...
  csum = csum << ((8u - ((FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN2 * FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LOGW) % 8u)) % 8u);
  FsmSw_Sphincs_UllToBytes(csum_bytes, sizeof(csum_bytes), csum);
  fsmsw_sphincssha2_192ssimple_wots_BaseW(csum_base_w, (sint32)FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN2, csum_bytes);
} /// end: fsmsw_sphincssha2_192ssimple_wots_Checksum
/**********************************************************************************************************************/
...
{
  fsmsw_sphincssha2_192ssimple_wots_BaseW(lengths, (sint32)FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN1, msg);
  fsmsw_sphincssha2_192ssimple_wots_Checksum(&lengths[FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN1], lengths);
} // end: FsmSw_SphincsSha2_192sSimple_Wots_ChainLengths
...
{
  uint32 lengths[FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN] = {0};
  uint32 i                                              = 0;

  FsmSw_SphincsSha2_192sSimple_Wots_ChainLengths(lengths, msg);

  for (i = 0; i < FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_LEN; i++)
  {
    FsmSw_SphincsSha2_SetChainAddr(addr, i);
    fsmsw_sphincssha2_192ssimple_wots_GenChain(&pk[i * FSMSW_SPHINCSSHA2_192SSIMPLE_N],
                                               &sig[i * FSMSW_SPHINCSSHA2_192SSIMPLE_N], lengths[i],
                                               FSMSW_SPHINCSSHA2_192SSIMPLE_WOTS_W - 1u - lengths[i], ctx, addr);
  }
} // end: FsmSw_SphincsSha2_192sSimple_Wots_PkFromSig
