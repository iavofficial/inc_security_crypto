 ...
 ** @{ */
/** \addtogroup SphincsSha2_128sSimple_utilsx1
 ** @{ */

/*====================================================================================================================*/
/** \file FsmSw_SphincsSha2_128sSimple_utilsx1.c
* \brief  description of FsmSw_SphincsSha2_128sSimple_utilsx1.c
*
* \details
*
*
...
and avoids confusion with other functions. Therefore, this warning is a false positive." */
void FsmSw_SphincsSha2_128sSimple_TreeHashX1(uint8 *const root, uint8 *const auth_path,
                                             ...
                                             void (*const gen_leaf)(uint8 *const out /* Where to write the leaves */,
                                                                    const sphincs_sha2_128s_ctx *const ctx, uint32 idx,
                                                                    void *const info),
                                             uint32 tree_addr[8], void *const info)
{
  uint8 stack[FSMSW_SPHINCSSHA2_128SSIMPLE_TREEHASHX1_BUF_LEN * FSMSW_SPHINCSSHA2_128SSIMPLE_N] = {0};
  ...
  for (idx = 0; idx < FSMSW_SPHINCS_UINT32_MAX_VALUE; idx++)
  {
    ...
    for (h = 0; h < FSMSW_SPHINCS_UINT32_MAX_VALUE; h++)
    {
      ...
      {
        FsmSw_CommonLib_MemCpy(&auth_path[h * FSMSW_SPHINCSSHA2_128SSIMPLE_N], &current[FSMSW_SPHINCSSHA2_128SSIMPLE_N],
      ...
      uint8 *const left = &stack[h * FSMSW_SPHINCSSHA2_128SSIMPLE_N];
      ...
      FsmSw_SphincsSha2_128sSimple_Thash(&current[FSMSW_SPHINCSSHA2_128SSIMPLE_N],
                                         &current[0u * FSMSW_SPHINCSSHA2_128SSIMPLE_N], 2u, ctx, tree_addr);
...
} // end: FsmSw_SphincsSha2_128sSimple_TreeHashX1
