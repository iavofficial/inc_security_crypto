...
/**********************************************************************************************************************/
void FsmSw_SphincsShake_128sSimple_InitializeHashFunction(sphincs_shake_128s_ctx *const ctx);

void FsmSw_SphincsShake_128sSimple_1FreeHashFunction(sphincs_shake_128s_ctx *const ctx);
