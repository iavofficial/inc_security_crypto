...
/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_128fSimple_hash_shake.c
* \brief  description of FsmSw_SphincsShake_128fSimple_hash_shake.c
*
* \details
*
*
...
/* DEFINES                                                                                                            */
/**********************************************************************************************************************/
#define SPX_TREE_BITS  (FSMSW_SPHINCSSHAKE_128FSIMPLE_TREE_HEIGHT * (FSMSW_SPHINCSSHAKE_128FSIMPLE_D - 1u))
#define SPX_TREE_BYTES ((SPX_TREE_BITS + 7u) / 8u)
#define SPX_LEAF_BITS  FSMSW_SPHINCSSHAKE_128FSIMPLE_TREE_HEIGHT
#define SPX_LEAF_BYTES ((SPX_LEAF_BITS + 7u) / 8u)
#define SPX_DGST_BYTES (FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_MSG_BYTES + SPX_TREE_BYTES + SPX_LEAF_BYTES)
...
void FsmSw_SphincsShake_128fSimple_PrfAddr(uint8 *const out, const sphincs_shake_128f_ctx *const ctx,
                                           const uint32 addr[8])
{
  uint8 buf[(2u * FSMSW_SPHINCSSHAKE_128FSIMPLE_N) + FSMSW_SPHINCSSHAKE_128FSIMPLE_ADDR_BYTES] = {0};
  ...
  FsmSw_CommonLib_MemCpy(&buf[FSMSW_SPHINCSSHAKE_128FSIMPLE_N + FSMSW_SPHINCSSHAKE_128FSIMPLE_ADDR_BYTES], ctx->sk_seed,
                                                    ...
                                                    const sphincs_shake_128f_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, sk_prf, FSMSW_SPHINCSSHAKE_128FSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, optrand, FSMSW_SPHINCSSHAKE_128FSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  FsmSw_Fips202_Shake256_IncFinalize(&s_inc);
  FsmSw_Fips202_Shake256_IncSqueeze(R, FSMSW_SPHINCSSHAKE_128FSIMPLE_N, &s_inc);
} // end: FsmSw_SphincsShake_128fSimple_GenMessageRandom
                                               ...
                                               uint32 mlen, const sphincs_shake_128f_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncInit(&s_inc);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, R, FSMSW_SPHINCSSHAKE_128FSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, pk, FSMSW_SPHINCSSHAKE_128FSIMPLE_PK_BYTES);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  FsmSw_Fips202_Shake256_IncFinalize(&s_inc);
  FsmSw_Fips202_Shake256_IncSqueeze(buf, SPX_DGST_BYTES, &s_inc);

  FsmSw_CommonLib_MemCpy(digest, bufp, FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_MSG_BYTES);
  bufp = &bufp[FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_MSG_BYTES];
...
} // end: FsmSw_SphincsShake_128fSimple_HashMessage
