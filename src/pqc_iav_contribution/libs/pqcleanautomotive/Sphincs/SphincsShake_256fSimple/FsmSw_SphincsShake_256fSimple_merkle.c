...
/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_256fSimple_merkle.c
* \brief  description of FsmSw_SphincsShake_256fSimple_merkle.c
*
* \details
*
*
                                               ...
                                               uint32 tree_addr[8], uint32 idx_leaf)
{
  ...
  uint32 steps[FSMSW_SPHINCSSHAKE_256FSIMPLE_WOTS_LEN] = {0};

  info.wots_sig = sig;
  FsmSw_SphincsShake_256fSimple_Wots_ChainLengths(steps, root);
  ...
  FsmSw_SphincsShake_256fSimple_TreeHashX1(root, auth_path, ctx, idx_leaf, 0, FSMSW_SPHINCSSHAKE_256FSIMPLE_TREE_HEIGHT,
                                           FsmSw_SphincsShake_256fSimple_Wots_GenLeafX1, tree_addr, &info);
} // end: FsmSw_SphincsShake_256fSimple_Merkle_Sign
...
void FsmSw_SphincsShake_256fSimple_Merkle_GenRoot(uint8 *const root, const sphincs_shake_256f_ctx *const ctx)
{
  ...
  FsmSw_SphincsShake_256fSimple_Merkle_Sign(auth_path, root, ctx, wots_addr, top_tree_addr,
                                            ~((uint32)0u) /* ~0 means "don't bother generating an auth path */);
} // end: FsmSw_SphincsShake_256fSimple_Merkle_GenRoot
