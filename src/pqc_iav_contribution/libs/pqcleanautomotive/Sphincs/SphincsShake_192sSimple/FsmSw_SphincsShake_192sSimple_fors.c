...
/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_192sSimple_fors.c
* \brief  description of FsmSw_SphincsShake_192sSimple_fors.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_192ssimple_fors_GenSk(uint8 *const sk, const sphincs_shake_192s_ctx *const ctx,
                                                     const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_192ssimple_fors_SkToLeaf(uint8 *const leaf, const uint8 *const sk,
                                                        const sphincs_shake_192s_ctx *const ctx,
                                                        const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_192ssimple_fors_GenLeafx1(uint8 *const leaf, const sphincs_shake_192s_ctx *const ctx,
                                                         uint32 addr_idx, void *const info);
static void fsmsw_sphincsshake_192ssimple_fors_MessageToIndices(uint32 *const indices, const uint8 *const m);
/**********************************************************************************************************************/
...
} // end: fsmsw_sphincsshake_192ssimple_fors_GenSk
...
} // end: fsmsw_sphincsshake_192ssimple_fors_SkToLeaf
...
} // end: fsmsw_sphincsshake_192ssimple_fors_GenLeafx1

/*====================================================================================================================*/
/**
 * \brief Interprets m as FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_HEIGHT-bit uint32. Assumes m contains at least
...
} // end: fsmsw_sphincsshake_192ssimple_fors_MessageToIndices
/**********************************************************************************************************************/
...
} // end: FsmSw_SphincsShake_192sSimple_Fors_Sign
                                                  ...
                                                  const sphincs_shake_192s_ctx *const ctx, const uint32 fors_addr[8])
{
  ...
  /* Hash horizontally across all tree roots to derive the public key. */
  FsmSw_SphincsShake_192sSimple_Thash(pk, roots, FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_TREES, ctx, fors_pk_addr);
} // end: FsmSw_SphincsShake_192sSimple_Fors_PkFromSig
