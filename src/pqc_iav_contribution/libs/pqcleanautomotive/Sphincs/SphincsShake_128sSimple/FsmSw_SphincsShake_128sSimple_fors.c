...
/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_128sSimple_fors.c
* \brief  description of FsmSw_SphincsShake_128sSimple_fors.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_128ssimple_fors_GenSk(uint8 *const sk, const sphincs_shake_128s_ctx *const ctx,
                                                     const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128ssimple_fors_SkToLeaf(uint8 *const leaf, const uint8 *const sk,
                                                        const sphincs_shake_128s_ctx *const ctx,
                                                        const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128ssimple_fors_GenLeafx1(uint8 *const leaf, const sphincs_shake_128s_ctx *const ctx,
                                                         uint32 addr_idx, void *const info);
static void fsmsw_sphincsshake_128ssimple_fors_MessageToIndices(uint32 *const indices, const uint8 *const m);
/**********************************************************************************************************************/
...
static void fsmsw_sphincsshake_128ssimple_fors_GenSk(uint8 *const sk, const sphincs_shake_128s_ctx *const ctx,
                                                     const uint32 fors_leaf_addr[8])
{
  FsmSw_SphincsShake_128sSimple_PrfAddr(sk, ctx, fors_leaf_addr);
} // end: fsmsw_sphincsshake_128ssimple_fors_GenSk
...
} // end: fsmsw_sphincsshake_128ssimple_fors_SkToLeaf
                                                         ...
                                                         uint32 addr_idx, void *const info)
{
  ...
  fsmsw_sphincsshake_128ssimple_fors_GenSk(leaf, ctx, fors_leaf_addr);

  FsmSw_SphincsShake_SetType(fors_leaf_addr, FSMSW_SPHINCS_ADDR_TYPE_FORSTREE);
  fsmsw_sphincsshake_128ssimple_fors_SkToLeaf(leaf, leaf, ctx, fors_leaf_addr);
} // end: fsmsw_sphincsshake_128ssimple_fors_GenLeafx1

/*====================================================================================================================*/
/**
 * \brief Interprets m as FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_HEIGHT-bit uint32 Assumes m contains at least
...
} // end: fsmsw_sphincsshake_128ssimple_fors_MessageToIndices
/**********************************************************************************************************************/
 ...
 *
 */
void FsmSw_SphincsShake_128sSimple_Fors_Sign(uint8 *const sig, uint8 *const pk, const uint8 *const m,
                                             const sphincs_shake_128s_ctx *const ctx, const uint32 fors_addr[8])
{
  ...
  fsmsw_sphincsshake_128ssimple_fors_MessageToIndices(indices, m);
  ...
  for (i = 0; i < FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_TREES; i++)
  {
    ...
    fsmsw_sphincsshake_128ssimple_fors_GenSk(sig_temp, ctx, fors_tree_addr);
    ...
    FsmSw_SphincsShake_128sSimple_TreeHashX1(&roots[i * FSMSW_SPHINCSSHAKE_128SSIMPLE_N], sig_temp, ctx, indices[i],
                                             idx_offset, FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_HEIGHT,
                                             fsmsw_sphincsshake_128ssimple_fors_GenLeafx1, fors_tree_addr, &fors_info);
...
} // end: FsmSw_SphincsShake_128sSimple_Fors_Sign
...
and avoids confusion with other functions. Therefore, this warning is a false positive." */
void FsmSw_SphincsShake_128sSimple_Fors_PkFromSig(uint8 *const pk, const uint8 *const sig, const uint8 *const m,
                                                  const sphincs_shake_128s_ctx *const ctx, const uint32 fors_addr[8])
{
  uint32 indices[FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_TREES]                                = {0};
  uint8 roots[FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_TREES * FSMSW_SPHINCSSHAKE_128SSIMPLE_N] = {0};
  ...
  for (i = 0; i < FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_TREES; i++)
  {
    ...
    fsmsw_sphincsshake_128ssimple_fors_SkToLeaf(leaf, sig_temp, ctx, fors_tree_addr);
    sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_128SSIMPLE_N];

    /* Derive the corresponding root node of this tree. */
    FsmSw_SphincsShake_128sSimple_ComputeRoot(&roots[i * FSMSW_SPHINCSSHAKE_128SSIMPLE_N], leaf, indices[i], idx_offset,
                                              sig_temp, FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_HEIGHT, ctx, fors_tree_addr);
    sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_128SSIMPLE_N * FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_HEIGHT];
  }

  /* Hash horizontally across all tree roots to derive the public key. */
  FsmSw_SphincsShake_128sSimple_Thash(pk, roots, FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_TREES, ctx, fors_pk_addr);
} // end: FsmSw_SphincsShake_128sSimple_Fors_PkFromSig
