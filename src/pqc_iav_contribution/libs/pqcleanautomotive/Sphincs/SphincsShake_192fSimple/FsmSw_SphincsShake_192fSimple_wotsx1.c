 ...
 ** @{ */
/** \addtogroup SphincsShake_192fSimple_wotsx1
 ** @{ */

/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_192fSimple_wotsx1.c
* \brief  description of FsmSw_SphincsShake_192fSimple_wotsx1.c
*
* \details
*
*
...
and avoids confusion with other functions. Therefore, this warning is a false positive." */
void FsmSw_SphincsShake_192fSimple_Wots_GenLeafX1(uint8 *const dest, const sphincs_shake_192f_ctx *const ctx,
                                                  uint32 leaf_idx, void *const v_info)
{
  ...
  /* polyspace +2 MISRA2012:11.5 [Justified:]"Necessary conversion from void* to object* for functionality.
    Ensured proper alignment and validity." */
  Fsmsw_Sphincsshake_192fSimple_LeafInfoX1_T *info          = v_info;
  uint32 *const leaf_addr                                   = info->leaf_addr;
  uint32 *const pk_addr                                     = info->pk_addr;
  uint32 i                                                  = 0;
  uint32 k                                                  = 0;
  uint8 pk_buffer[FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_BYTES] = {0};
  ...
  for (i = 0; i < FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN; i++)
  {
    ...
    FsmSw_SphincsShake_192fSimple_PrfAddr(buffer, ctx, leaf_addr);
...
} // end: FsmSw_SphincsShake_192fSimple_Wots_GenLeafX1
