 ...
 ** @{ */
/** \addtogroup SphincsShake_192fSimple_params
 ** @{ */

/*====================================================================================================================*/
/** \file FsmSw_SphincsShake_192fSimple_params.h
* \brief  Description of FsmSw_SphincsShake_192fSimple_params.h
*
* \details
*
*
...
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN1                                                                        \
  (8u * FSMSW_SPHINCSSHAKE_192FSIMPLE_N / FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LOGW)
...
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN                                                                         \
  (FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN1 + FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN2)
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_BYTES                                                                       \
  (FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN * FSMSW_SPHINCSSHAKE_192FSIMPLE_N)

/* Subtree size. */
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_TREE_HEIGHT                                                                      \
  (FSMSW_SPHINCSSHAKE_192FSIMPLE_FULL_HEIGHT / FSMSW_SPHINCSSHAKE_192FSIMPLE_D)

/* FORS parameters. */
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_MSG_BYTES                                                                   \
  (((FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_HEIGHT * FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_TREES) + 7u) / 8u)
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_BYTES                                                                       \
  ((FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_HEIGHT + 1u) * FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_TREES *                       \
   FSMSW_SPHINCSSHAKE_192FSIMPLE_N)

/* Resulting SPX sizes. */
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_BYTES                                                                            \
  (FSMSW_SPHINCSSHAKE_192FSIMPLE_N + FSMSW_SPHINCSSHAKE_192FSIMPLE_FORS_BYTES +                                        \
   (FSMSW_SPHINCSSHAKE_192FSIMPLE_D * FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_BYTES) +                                      \
   (FSMSW_SPHINCSSHAKE_192FSIMPLE_FULL_HEIGHT * FSMSW_SPHINCSSHAKE_192FSIMPLE_N))
...
#define FSMSW_SPHINCSSHAKE_192FSIMPLE_SK_BYTES                                                                         \
  (2 * FSMSW_SPHINCSSHAKE_192FSIMPLE_N + FSMSW_SPHINCSSHAKE_192FSIMPLE_PK_BYTES)
