...
/*====================================================================================================================*/
/** \file FsmSw_sha2.c
* \brief  description of FsmSw_sha2.c
*
* \details
*
*
...
/* DEFINES                                                                                                            */
/**********************************************************************************************************************/
/* polyspace +82 CERT-C:PRE00-C [Justified:]"No refactoring of macros, as converting to, for example, 
...
static uint32 fsmsw_sha2_LoadBigendian32(const uint8 *const x);
static uint64 fsmsw_sha2_LoadBigendian64(const uint8 *const x);
static void fsmsw_sha2_StoreBigendian32(uint8 *const x, uint64 u);
static void fsmsw_sha2_StoreBigendian64(uint8 *const x, uint64 u);
...
* \brief t.b.d.
*
* \param[in] uint8 *statebytes : t.b.d.
...
static uint32 fsmsw_sha2_crypto_HashBlocksSha256(uint8 *const statebytes, const uint8 *const in, uint32 inlen)
{
  ...
  return inlen_temp;
} // end: fsmsw_sha2_crypto_HashBlocksSha256
...
static uint32 fsmsw_sha2_crypto_HashBlocksSha512(uint8 *const statebytes, const uint8 *const in, uint32 inlen)
{
  ...
  return inlen_temp;
} // end: fsmsw_sha2_crypto_HashBlocksSha512

/*====================================================================================================================*/
/**
* \brief t.b.d.
*
* \param[in] uint8  *x : t.b.d.
*
*/
static uint32 fsmsw_sha2_LoadBigendian32(const uint8 *const x)
{
  return (uint32)(x[3]) | (((uint32)(x[2])) << 8) | (((uint32)(x[1])) << 16) | (((uint32)(x[0])) << 24);
} // end: fsmsw_sha2_LoadBigendian32

/*====================================================================================================================*/
/**
* \brief t.b.d.
*
* \param[in] const uint8 *x : t.b.d.
*
*/
static uint64 fsmsw_sha2_LoadBigendian64(const uint8 *const x)
{
...
} // end: fsmsw_sha2_LoadBigendian64

/*====================================================================================================================*/
/**
* \brief t.b.d.
*
* \param[out] uint8 *x : t.b.d.
* \param[in]  uint64 u : t.b.d.
*
*/
static void fsmsw_sha2_StoreBigendian32(uint8 *const x, uint64 u)
{
  ...
  u_temp >>= 8;
  x[0] = (uint8)u_temp;
} // end: fsmsw_sha2_StoreBigendian32
...
static void fsmsw_sha2_StoreBigendian64(uint8 *const x, uint64 u)
{
  ...
  u_temp >>= 8;
  x[0] = (uint8)u_temp;
} // end: fsmsw_sha2_StoreBigendian64

/*====================================================================================================================*/
/**
* \brief Initialize the incremental hashing API. Can't be called multiple times.
*
* \param[out] sha224ctx *state : t.b.d.
*
*/
static void fsmsw_sha224_IncInit(sha224ctx *const state)
{
...
} // end: fsmsw_sha224_IncInit

/*====================================================================================================================*/
/**
* \brief Initialize the incremental hashing API.
*
* \param[out] sha384ctx *state : t.b.d.
*
*/
static void fsmsw_sha384_IncInit(sha384ctx *const state)
{
...
} // end: fsmsw_sha384_IncInit

/*====================================================================================================================*/
/**
* \brief Finalize and obtain the digest. If applicable, this function will free the memory associated with
*        the sha224ctx.
*
...
} // end: fsmsw_sha224_IncFinalize

/*====================================================================================================================*/
/**
* \brief Finalize and obtain the digest. If applicable, this function will free the memory associated with the
*        sha384ctx.
*
* \param[out] uint8       *out : t.b.d.
* \param[in]  sha384ctx *state : t.b.d.
* \param[in]  const uint8  *in : t.b.d.
* \param[in]  uint32     inlen : t.b.d.
*
*/
...
* \brief Initialize the incremental hashing API.
*
* \param[out] sha256ctx *state : t.b.d.
*
*/
...
} // end: FsmSw_Sha256_IncInit

/*====================================================================================================================*/
/**
* \brief Initialize the incremental hashing API.
*
* \param[out] sha512ctx *state : t.b.d.
*
*/
...
} // end: FsmSw_Sha512_IncInit

/*====================================================================================================================*/
/**
* \brief Copy the hashing state
*
* \param[out] sha224ctx      *stateout : t.b.d.
* \param[in]  const sha224ctx *statein : t.b.d.
*
*/
...
} // end: FsmSw_Sha224_IncCtxClone

/*====================================================================================================================*/
/**
* \brief Copy the hashing state.
*
* \param[out] sha256ctx      *stateout : t.b.d.
* \param[in]  const sha256ctx *statein : t.b.d.
*
*/
void FsmSw_Sha256_IncCtxClone(sha256ctx *stateout, const sha256ctx *const statein)
{
  FsmSw_CommonLib_MemCpy(stateout->ctx, statein->ctx, PQC_SHA256CTX_BYTES);
} // end: FsmSw_Sha256_IncCtxClone

/*====================================================================================================================*/
/**
* \brief Copy the hashing state.
*
* \param[out] sha384ctx      *stateout : t.b.d.
* \param[in]  const sha384ctx *statein : t.b.d.
*
*/
...
} // end: FsmSw_Sha384_IncCtxClone

/*====================================================================================================================*/
/**
* \brief Copy the hashing state.
*
* \param[out] sha512ctx      *stateout : t.b.d.
* \param[in]  const sha512ctx *statein : t.b.d.
*
*/
void FsmSw_Sha512_IncCtxClone(sha512ctx *stateout, const sha512ctx *const statein)
{
  FsmSw_CommonLib_MemCpy(stateout->ctx, statein->ctx, PQC_SHA512CTX_BYTES);
} // end: FsmSw_Sha512_IncCtxClone

/*====================================================================================================================*/
/**
* \brief Absorb blocks.
*
* \param[in,out] sha256ctx *state : t.b.d.
* \param[in]     const uint8  *in : t.b.d.
...
} // end: FsmSw_Sha224_IncBlocks

/*====================================================================================================================*/
/**
* \brief Absorb blocks.
*
* \param[in,out] sha512ctx *state : t.b.d.
* \param[in]     const uint8  *in : t.b.d.
* \param[in]     uint32  inblocks : t.b.d.
*
*/
...
} // end: FsmSw_Sha512_IncBlocks

/*====================================================================================================================*/
/**
* \brief Absorb blocks.
*
* \param[in,out] sha384ctx *state : t.b.d.
* \param[in]     const uint8  *in : t.b.d.
* \param[in]     uint32  inblocks : t.b.d.
*
*/
...
} // end: FsmSw_Sha512_IncFinalize

/*====================================================================================================================*/
/**
* \brief All-in-one FsmSw_Sha224 function.
*
* \param[out] uint8      *out : t.b.d.
* \param[in]  const uint8 *in : t.b.d.
* \param[in]  uint32    inlen : t.b.d.
...
/*====================================================================================================================*/
/**
* \brief All-in-one FsmSw_Sha256 function.
*
* \param[out] uint8      *out : t.b.d.
* \param[in]  const uint8 *in : t.b.d.
* \param[in]  uint32    inlen : t.b.d.
...
/*====================================================================================================================*/
/**
* \brief All-in-one FsmSw_Sha384 function.
*
* \param[out] uint8      *out : t.b.d.
* \param[in]  const uint8 *in : t.b.d.
* \param[in]  uint32    inlen : t.b.d.
...
/*====================================================================================================================*/
/**
* \brief All-in-one FsmSw_Sha512 function.
*
* \param[out] uint8      *out : t.b.d.
* \param[in]  const uint8 *in : t.b.d.
* \param[in]  uint32    inlen : t.b.d.
